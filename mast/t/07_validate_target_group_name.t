...
Property {
    ...
    my $res = eval {Mast::Cloud::Spec::v1_0::_validate_elb_target_group_name(undef, $target_group_name, 0)};
    if($@){
        # diag $@;
...
Property {
    ...
    my $res = eval {Mast::Cloud::Spec::v1_0::_validate_elb_target_group_name(undef, $target_group_name)};
    if($@){
        # diag $@;
